...
- **LibraryQR**: `simplesoftwareio/simple-qrcode` untuk generate QR code.
...
- **OTP Verification**: 6 digit kode dikirim via email/nilai session untuk verifikasi registrasi dan reset password.
