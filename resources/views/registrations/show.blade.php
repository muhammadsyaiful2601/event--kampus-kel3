                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0 fw-semibold">{{ \Carbon\Carbon::parse($registration->event->date)->format('d M Y H:i') }}</p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label text-muted small">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0 fw-semibold">{{ $registration->created_at->format('d M Y H:i') }}</p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label text-muted small">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    @elseif($registration->status === 'diterima')
                                                        <span class="badge bg-success d-inline-flex align-items-center">
                                                            <i class="bx bx-check-circle me-1"></i>Diterima - Pendaftaran Disetujui
                                                        </span>
                                                    @else
                                                        <span class="badge bg-danger d-inline-flex align-items-center">
                                                            <i class="bx bx-x-circle me-1"></i>Ditolak - Pendaftaran Ditolak
                                                        </span>
                                                    @endif
                                                </p>
                                            </div>
                                ...
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center mb-4">
                                            @if($registration->status === 'pending')
                                                <div class="badge bg-warning text-dark p-3" style="font-size: 1.1rem;">
                                                    <i class="bx bx-time"></i> PENDING
                                                </div>
                                                <p class="text-muted small mt-2 mb-0">Menunggu verifikasi dari admin</p>
                                            @elseif($registration->status === 'diterima')
